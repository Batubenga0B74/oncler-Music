...
import construcao from "../../public/construcao.png"
...
const HomeClient: React.FC<HomeClientProps> = ({ tracks }) => {
    ...
    <div>
      ...
      <section className="flex flex-col lg:flex-row justify-center items-center gap-14 py-5 px-4">
        <div className="flex flex-col lg:flex-row justify-center gap-5 bg-[#1E1E1E] w-full lg:w-auto">
          <section className="bg-[url('/music.png')] bg-cover w-full sm:w-[500px] lg:w-[800px] h-[200px] sm:h-[250px] lg:h-[322px]" />
          <span className="flex text-white text-center justify-center flex-col gap-3 px-6 sm:px-12 lg:px-28">
            ...
            <section className="text-center justify-center flex">
              <p className="max-w-[352px] font-semibold leading-[23px] text-center tracking-normal text-[#A49797]">
                Monic is an artist-first music platform that helps artists{" "}
                <span className="text-white">share their music</span>
              </p>
            </section>
            <div className="py-2">
      ...
      <main className="py-5 flex flex-col lg:flex-row justify-center items-start gap-10 px-4">
        ...
        <section className="flex flex-col gap-10 justify-center px-10 sm:items-center ">
          <div className="sm:w-[384px] border-b-2 border-b-[#A49797]">
            <h1 className="w-[100px] text-xl text-[#53AA00] py-8 font-semibold">
              BROWSER
            </h1>
            ...
            <p className="font-semibold text-[#A49797] leading-8">Recently supported</p>
            <p className="font-semibold text-[#A49797] leading-8">Recently added</p>
            <p className="font-semibold text-[#A49797] leading-8 pb-10">Account for you added</p>
          </div>
          ...
          <span className="text-center flex flex-col gap-3 justify-center">
            <div className="text-center flex flex-wrap justify-center items-center gap-3">
              <button
                ...
                className="w-[117px] h-[44px] rounded-3xl border-2 border-[#53AA00] text-white font-semibold"
              >
                ALBUM
              </button>
              <button className="w-[117px] h-[44px] rounded-3xl border-2 border-[#53AA00] text-white font-semibold">
                MIXTAPE
              </button>
            </div>
            <div>
      ...
      {openModal && (
        <Modal onClose={() => setOpenModal(false)}>
          <div className="text-xl font-semibold mb-4 text-white">
            <Image alt="construcao" src={construcao}/>
          </div>
          <p className="text-gray-200 mb-6">
            Essa pagina esta em construção, em breve teremos essa seção
          </p>
        </Modal>
      )}
    </div>
